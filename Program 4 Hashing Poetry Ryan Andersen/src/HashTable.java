...
public class HashTable<E, J>
{
     ...
     */
    public boolean insert( E key, J value)
    {
        // Insert x as active
        Pair<E, J> x = new Pair(key, value);
    ...
    public String toString() {
        ...
        for(var k : array){
            if(k != null && k.isActive){
                WordFreqInfo winfo = (WordFreqInfo) k.element.value;
                str += winfo + "\n";
            }
        }
        return str;
    ...
    private int findPos( E x )
    {
        ...
        while( array[ currentPos ] != null &&
                !array[ currentPos ].element.key.equals( x ) )
        {
    ...
    {
        public Pair<E, J>  element;   // the element
        public boolean isActive;  // false if marked deleted

        public HashEntry( Pair<E, J> e )
        {
            this( e, true );
        }

        public HashEntry( Pair<E, J> e, boolean i )
        {
            element  = e;
            isActive = i;
        }
    ...
    public static void main( String [ ] args )
    {
        ...
        H.insert("OwO", "What's this?");
        H.insert("Joseph", "Joestar");
        System.out.println(H.find("Joseph"));
        System.out.println(H.find("OwO"));
        H.remove("Joseph");
        System.out.println(H.find("Joseph"));
